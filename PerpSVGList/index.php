...
$noUse = [
    ...
    'OC_Icons_Dez_2021_+_Attributs/viewcache/new-entry-18.svg' => ['alternative' => 'OC_Icons_Dez_2021_+_Attributs/viewcache/16x16-note.svg'],
    'OC_Icons_Dez_2021_+_Attributs/action/16x16-log.svg' => ['alternative' => 'OC_Icons_Dez_2021_+_Attributs/viewcache/logs.svg'],
];
...
$manualList = [
    ...
    'OC_Icons_Dez_2021_+_Attributs/action/16x16-ignore.svg' =>                 ['group' => 'misc', 'newName' => 'lens-red.svg'],
...
foreach($files as $file) {
    ...
    elseif (preg_match('#/wp_#', $file)) {
        ...
        $svg['newName'] = str_replace(['wp_', 'note', 'prototype'], ['', 'presenter', 'blank'], basename($file));
        $svg['sort'] = sprintf($groupSort, $svg['group'], $svg['newName']);
    }
